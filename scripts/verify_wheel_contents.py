...
(release metadata, templates, translations, static assets, deployment examples),
so a broken build fails here with a precise message instead of at smoke-test time.
main() also cross-checks
